...
public class RoleController {
	 ...
	 */
	@GetMapping(value = "/displayRoleUserProjectByUser")
	Role displayRoleUserProjectByUser(@RequestParam("idUser") Long idUser) {
		...
		if (user.getRole().getName().equals("admin")) {
			...
			if (daoS.displayRoleUserProjectByUser(idUser) >= 1) {
