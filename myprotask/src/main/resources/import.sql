...
INSERT INTO projects (name, description, start_date, finish_date, vacancies, is_active) VALUES ('Frontend UI Design for Cybersecurity Dashboard', 'Design an intuitive and responsive user interface for the cybersecurity dashboard, focusing on usability and data visualization.', '2024-01-15', '2030-07-15', 7, 1);
...
INSERT INTO projects (name, description, start_date, finish_date, vacancies, is_active) VALUES ('Mobile App Backend Infrastructure Setup', 'Set up the backend infrastructure for a mobile application, including API endpoints, database management, and server configurations.', '2024-04-25', '2030-09-25', 6, 1);
INSERT INTO projects (name, description, start_date, finish_date, vacancies, is_active) VALUES ('Frontend Development for Data Analytics Dashboard', 'Implement frontend components for a data analytics dashboard, focusing on interactive data visualization and user-friendly design.', '2024-01-30', '2030-10-30', 6, 1);
...
INSERT INTO users (name, last_name, das, email, password, profile_pic, cv, is_active, role_id) VALUES ('Hugo', 'Crespo', 'MPT000002', 'hugo.crespo@mpt.com', 'Abcdefg1!', 'profile_pic.png', 'cv.pdf', 1, 2);
INSERT INTO users (name, last_name, das, email, password, profile_pic, cv, is_active, role_id) VALUES ('Sergio', 'Ramos', 'MPT000003', 'sergio.ramos@mpt.com', '1234', 'profile_pic.png', 'cv.pdf', 1, 2);
INSERT INTO users (name, last_name, das, email, password, profile_pic, cv, is_active, role_id) VALUES ('Anas', 'Rami', 'MPT000004', 'anas.rami@mpt.com', 'Abcdefg1!', 'profile_pic.png', 'cv.pdf', 1, 2);
INSERT INTO users (name, last_name, das, email, password, profile_pic, cv, is_active, role_id) VALUES ('Alejandro', 'Cuesta', 'MPT000005', 'alejandro.cuesta@mpt.com', 'Abcdefg1!', 'profile_pic.png', 'cv.pdf', 1, 2);
INSERT INTO users (name, last_name, das, email, password, profile_pic, cv, is_active, role_id) VALUES ('Aris', 'Khus', 'MPT000006', 'aris.khus@mpt.com', 'Abcdefg1!', 'profile_pic.png', 'cv.pdf', 1, 2);
INSERT INTO users (name, last_name, das, email, password, profile_pic, cv, is_active, role_id) VALUES ('Ivan', 'Garcia', 'MPT000007', 'ivan.garcia@mpt.com', 'Abcdefg1!', 'profile_pic.png', 'cv.pdf', 1, 2);
INSERT INTO users (name, last_name, das, email, password, profile_pic, cv, is_active, role_id) VALUES ('Manuel', 'Sanz', 'MPT000008', 'manuel.sanz@mpt.com', 'Abcdefg1!', 'profile_pic.png', 'cv.pdf', 1, 2);
INSERT INTO users (name, last_name, das, email, password, profile_pic, cv, is_active, role_id) VALUES ('Kevin Sebastián', 'Bayas', 'MPT000009', 'kevin.sebastias.bayas@mpt.com', 'Abcdefg1!', 'profile_pic.png', 'cv.pdf', 1, 2);
